...
{
    public abstract class TravelAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TravelAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TravelAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TravelAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TravelAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TravelAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TravelAppDbContext, Task<T>> func)
        {
            T result;
