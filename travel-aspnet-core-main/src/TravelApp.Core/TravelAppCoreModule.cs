...
namespace TravelApp
{
    ...
    public class TravelAppCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.Settings.SettingEncryptionConfiguration.DefaultPassPhrase = TravelAppConsts.DefaultPassPhrase;
            SimpleStringCipher.DefaultPassPhrase = TravelAppConsts.DefaultPassPhrase;
        }
